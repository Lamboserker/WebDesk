      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            ...
            Integrate video chats, collaborative workspaces, and direct GitHub repository access in one seamless platform
            </p>
      ...
      >
        All-in-One Collaboration Hub
         ...
         Customizable spaces to bring your projects to life.
          ...
          Collaborate on documents, code, and more in real time.
          </p>
        </div>
        <div className="mx-auto mt-10 max-w-2xl lg:mx-0 lg:max-w-none">
         
          <motion.dl className="mt-16 grid grid-cols-1 gap-8 sm:mt-20 sm:grid-cols-2 lg:grid-cols-4"
