...
const RightSidebar = ({ isOpen, setIsOpen }) => {
  const variants = {
    ...
    closed: { width: "0px", opacity: 0, transition: { duration: 0.5 } },
  };
  ...
  return (
    <motion.div animate={isOpen ? "open" : "closed"} variants={variants}>
      <div className="relative">
        ...
        {/* Close Icon outside Sidebar, directly at the edge 
        {isOpen && (
          <button
            className="absolute top-1/2 left-0 transform -translate-y-1/2 text-4xl hover:scale-110 transition-transform"
