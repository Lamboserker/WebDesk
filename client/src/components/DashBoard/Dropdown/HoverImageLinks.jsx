...
export const HoverImageLinks = ({ handleSelectionChange, workspaces }) => {
        ...
        {workspaces.map((workspace, index) => {
          ...
          return (
            <Link
              ...
              imgSrc={imageUrl}
              onClick={() => handleSelectionChange(workspace._id)}
            />
          );
        })}
      </div>
    ...
    >
      <div>
        <motion.span
          ...
          className="relative z-10 block text-md font-bold text-neutral-500 transition-colors duration-500 group-hover:text-neutral-50 md:text-xl"
        >
